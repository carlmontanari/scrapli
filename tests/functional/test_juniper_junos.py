def test_configuration_exclusive(junos_conn):
    ...
    result = junos_conn.send_configs(["status"], privilege_level="configuration_exclusive")
    junos_conn.close()
...
def test_configuration_private(junos_conn):
    ...
    result = junos_conn.send_configs(["status"], privilege_level="configuration_private")
    junos_conn.close()
