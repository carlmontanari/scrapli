...
def test_on_open_on_close(mocked_eos_driver):
    channel_input_1 = "\n"
    channel_output_1 = "\nlocalhost#"
    channel_input_2 = "terminal length 0"
    channel_output_2 = "\nlocalhost#"
    channel_input_3 = "terminal width 32767"
    channel_output_3 = "\nlocalhost#"
    channel_input_4 = "\n"
    channel_output_4 = "\nlocalhost#"
    ...
    # mocked eos driver already calls `.open()` so we are just testing that the open commands
    ...
    conn = mocked_eos_driver(test_operations)
    conn.close()
