...
##### read_callback
`read_callback(self, callbacks: List[ForwardRef('ReadCallback')], initial_input: Optional[str] = None, read_output: bytes = b'', read_delay: float = 0.1) ‑> ReadCallbackReturnable`
